...
const Hero = () => {
      return (
            <div className=" bg-primary-color h-[550px] md:h-[622px]   lg:mx-6 " id='banner'>
                  ...
                  <div className=" max-w-72 sm:max-w-2xl  lg:max-w-2xl xl:max-w-3xl 2xl:max-w-5xl mx-auto relative top-32 md:top-16 border-2 border-white bg-white bg-opacity-25 p-6 rounded-2xl">
