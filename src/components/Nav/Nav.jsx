                  ...
                  <div className="navbar container mx-auto ">
                        ...
                        <div className="navbar-end">
                              <div className=" text-2xl font-semibold flex items-center gap-3  text-black">
                                    <span className="bg-white p-2 rounded-full cursor-pointer"><MdOutlineShoppingCart /></span>
                                    <span className="bg-white p-2 rounded-full cursor-pointer"><CiHeart /></span>
                              </div>
                        </div>
                  </div>
            </nav>
