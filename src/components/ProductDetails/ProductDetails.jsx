...
const ProductDetails = () => {
      ...
      return (
            <div className="bg-primary-color h-96 py-7  mb-96">
                              ...
                              <div className="flex gap-8">
                                    ...
                                    <div className="text-lg flex flex-col justify-between h-full gap-2 ">
                                          ...
                                          <div className=" flex gap-4">
                                                <button className=" btn flex items-center gap-2 bg-primary-color text-white">Add to cart <IoCartOutline className="text-xl" /></button>
